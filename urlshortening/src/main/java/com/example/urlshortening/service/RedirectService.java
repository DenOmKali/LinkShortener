...
import com.example.urlshortening.exception.BadRequestException;
import com.example.urlshortening.exception.NotFoundException;
import com.example.urlshortening.repository.RedirectRepository;
...
@Service
public class RedirectService extends Redirect{
    ...
    public Redirect getRedirect(String alias){
        Redirect redirect = redirectRepository.findByAlias(alias)
                .orElseThrow(() -> new NotFoundException("Dont work, this so bad((("));
        return redirect;
    }
